...
bl_info = {
    ...
    "description": "Perform PCA projection on selected vertices and update their positions with fixed start/end points for the curve",
    "warning": "",
    "doc_url": "",
    "category": "Mesh",
}
