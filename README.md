...
## Environment
CurveFitting V0.1.3 and later were developed and tested with Blender 4.2.   
If you want to use CurveFitting in Blender 3.6 or earlier, please use CurveFitting V0.1.0.
